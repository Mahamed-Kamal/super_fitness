...
void main() {
  Widget createWidgetUnderTest({required String name, required String measure}) {
    return MaterialApp(
  ...
  testWidgets(
    'should render capitalized name and trimmed measure',
  ...
  testWidgets(
    'should apply correct theme colors and styles',
        (WidgetTester tester) async {
      await tester.pumpWidget(
  ...
  testWidgets(
    'should handle empty name string gracefully',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        createWidgetUnderTest(name: '', measure: 'N/A'),
      );
    ...
    'should handle long ingredient names using Expanded to prevent overflow',
      ...
      await tester.pumpWidget(
        createWidgetUnderTest(
          name: 'Extremely long ingredient name that would usually cause overflow',
          measure: '100g',
        ),
      );
