...
void main() {
  testWidgets('should render with correct gradient and icon', (
    WidgetTester tester,
  ) async {
    // Wrap in MaterialApp/Scaffold to provide Directionality for the Icon
    await tester.pumpWidget(
      const MaterialApp(home: Scaffold(body: PlaceholderHero())),
    );
    ...
    expect(gradient.colors, [const Color(0xFF2A1A10), const Color(0xFF1A1A1A)]);
